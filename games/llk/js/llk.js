$(function(){
	(function(){
		var headPicWidth=$(".headPic").css("width").replace("px","");
		var headPicHeight=Math.round(parseInt(headPicWidth)*0.2)+"px";
		var headPicMargin=-(Math.round(parseInt(headPicWidth)*0.077)+20)+"px";
		$(".headPic").css({"height":headPicHeight,"margin-top":headPicMargin});
		...
		$("#btnRemoveOrder").on("click",function(){
...
// canvas obj
        ...
        window.onload = function () {
            ...
            if(document.body.offsetWidth<678){
            	var imgSizeDefault=20;
            	var imgRadiusDefault=4;
            }
            else{
            	var imgSizeDefault=60;
            	var imgRadiusDefault=10;
            }
            _img_face_m = 13;
            _img_face_n = 4;
            _img_face_src_width = imgSizeDefault;
            _img_face_src_height = imgSizeDefault;
            _img_face_width = imgSizeDefault;
            _img_face_height = imgSizeDefault;
            _img_face_radius = imgRadiusDefault;
